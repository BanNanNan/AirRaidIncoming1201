package net.mcreator.airraidpewpew;
...
@Mod("airraidpewpew")
public class AirraidpewpewMod {
	public static final Logger LOGGER = LogManager.getLogger(AirraidpewpewMod.class);
	public static final String MODID = "airraidpewpew";

	public AirraidpewpewMod(FMLJavaModLoadingContext context) {
